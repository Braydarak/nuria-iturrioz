...
type BitsLogoLoopProps = {
  ...
  itemHeightOverrides?: Record<number, number>;
};
    ...
    >
      ...
      >
        {renderItems.map((item, idx) => {
          const baseIndex = (idx % logos.length) + 1;
          const overrideHeight = itemHeightOverrides?.[baseIndex];
          const commonStyle: React.CSSProperties = {
            height: overrideHeight ? `${overrideHeight}px` : undefined,
          };
