      ...
      <div className="mx-auto max-w-screen px-8 md:px-16 lg:px-24 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          <div className="relative">
            ...
            <div className="overflow-hidden rounded-3xl shadow-2xl ring-1 ring-white/20 w-full max-w-[380px] md:max-w-[460px]" style={{ aspectRatio: '3 / 4' }}>
              <img
                src={nuri}
                alt="Nuria Iturrioz"
          ...
          <div className="space-y-4">
            ...
            <svg className="mt-1" width="180" height="12" viewBox="0 0 180 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M2 10 C 50 2, 130 2, 178 10" stroke="rgba(255,255,255,0.85)" strokeWidth="3" fill="none" strokeLinecap="round"/>
            </svg>
            <div className="text-2xl leading-relaxed">
              ...
              <p className="mt-4">
                Aquí podréis saber un poco más de mí, de mi pasado, mi presente y mi futuro.
              </p>
              <p className="mt-4">
                ¡Espero que os guste y podáis disfrutar de mi carrera acompañándome por todo el mundo!
              </p>
              <p className="mt-4">
            ...
            <div className="pt-2">
              ...
              >
                ...
                >
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 8.75 21 12l-3.75 3.25M3 12h18" />
                </svg>
              </a>
            </div>
          </div>         
              ...
              <div className="pt-30">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 justify-items-center text-center">
                  <div>
                    <div className="font-signature text-6xl sm:text-7xl text-white leading-tight tracking-tight">{age}</div>
                    <div className="mt-2 text-xl sm:text-2xl text-white">Edad</div>
                  </div>
                  <div>
                    <div className="font-signature text-6xl sm:text-7xl text-white leading-tight tracking-tight">{wins ?? 0}</div>
                    <div className="mt-2 text-xl sm:text-2xl text-white">Victorias LET</div>
                  </div>
                  <div>
                    <div className="font-signature text-6xl sm:text-7xl text-white leading-tight tracking-tight">{tournaments ?? 0}</div>
                    <div className="mt-2 text-xl sm:text-2xl text-white">Torneos jugados</div>
                  </div>
                  <div>
                    <div className="font-signature text-6xl sm:text-7xl text-white leading-tight tracking-tight">{visited}</div>
                    <div className="mt-2 text-xl sm:text-2xl text-white">Países visitados</div>
                  </div>
                </div>
              </div>
            )}
