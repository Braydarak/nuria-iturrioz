...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-100 w-full font-header transform transition-all drop-shadow-md duration-300 ${
        visible
    ...
    >
      <div className="mx-auto max-w-screen">
        <div className="flex h-20 md:h-22 items-center justify-between md:justify-around px-4">
          {/* Left: Logo */}
          <Link
            to="/"
          ...
          >
            <img
              ...
              alt="Nuria Iturrioz"
              className="md:h-16 h-14 w-auto md:m-0 pl-5"
            />
          </Link>
        ...
        <div
          ...
          className={`md:hidden transition-all duration-500 ease-in-out ${
            open
              ? "h-[calc(100dvh-5rem)] overflow-hidden opacity-100 translate-y-0 border-t border-[#E6E6E6] bg-[#F8F8F8]"
              : "h-0 overflow-hidden opacity-0 -translate-y-5"
          }`}
        >
          <div className="flex flex-col h-full w-full">
            <div className="flex-1 overflow-y-auto overscroll-contain pt-10">
              <div className="flex flex-col items-center justify-center text-xl gap-7 pb-10">
                <Link
                  to="/"
